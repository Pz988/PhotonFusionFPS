...
public class NetworkCharacterControllerPrototypeCustom : NetworkTransform {
  ...
  public virtual void Move(Vector3 direction) {
    ...
    if (direction == default) {
      ...
      // dont need to use, this matches rotation with direction making the view match the movement. (unable to strafe, indpentent movement of player to camera .//transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.LookRotation(direction), rotationSpeed * Runner.DeltaTime);
    }
